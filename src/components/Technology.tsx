...
const Technology = () => {
  ...
  return (
    <>
      ...
      {/* New Section Below Products Page */}
      <section className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center w-full">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Next Section</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            This is a new section below the Products page. The background is solid black.
          </p>
        </div>
      </section>
      ...
      <section className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center w-full">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Second Section</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            This is the second new section below the Products page. The background is solid black.
          </p>
        </div>
      </section>
      {/* Third Black Section */}
      <section className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center w-full">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Third Section</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            This is the third new section below the Products page. The background is solid black.
          </p>
        </div>
      </section>
    </>
