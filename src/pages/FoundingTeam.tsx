      ...
      <section className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          {founders.map((founder, idx) => (
            <div key={idx} className="bg-card/80 rounded-xl shadow-lg p-8 flex flex-col items-center text-center border border-border hover:neon-glow transition-all duration-300">
              ...
              <p className="text-primary font-medium mb-2 neon-text">{founder.role}</p>
              <a href={founder.linkedin} target="_blank" rel="noopener noreferrer" className="text-primary underline mb-4 hover:text-primary/80 transition-colors">Connect on LinkedIn</a>
        ...
        <div className="text-center mt-12">
          ...
          <a href="/careers" className="inline-block px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg shadow hover:bg-primary/90 transition neon-glow">See open roles →</a>
        </div>
